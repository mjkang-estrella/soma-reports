Generate a plain-English Short Read Mapper report from local derived bioinformatics evidence and supplied reference resources.
...
If short-read mapping, alignment metrics, coverage, variant calls, sequencing-file handling, pipeline command line, tool versions, or authenticated sample evidence is missing, mark that field or section unavailable instead of inferring it.
...
State that short-read mapping requires supplied execution artifacts and this fixture does not supply mapped reads or derived metrics.
