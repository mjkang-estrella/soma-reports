# Ovarian Cancer Risk & Prevention local-agent prompt

Generate a plain-English Ovarian Cancer Risk & Prevention report from local genome-derived evidence and supplied reference resources.
...
For this package, focus on ovarian cancer risk and prevention education, inherited-cancer testing limits, model-unavailable disclosure, and genetic-counseling review boundaries.
...
For Ovarian Cancer Risk & Prevention, the public Disease Risk Genetic Test Report sample PDF contains sibling cancer-category output-structure evidence.
