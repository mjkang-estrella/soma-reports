Generate a plain-English EvE Premium report from local derived bioinformatics evidence and supplied reference resources.
...
If pipeline execution, secondary calls, QC metrics, clinical classifications, generated reports, command line, checksums, or authenticated sample evidence is missing, mark that field or section unavailable instead of inferring it.
...
State that pipeline-style outputs require supplied execution artifacts and this fixture does not supply a run.
