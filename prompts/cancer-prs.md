# Cancer PRS local-agent prompt

Generate a plain-English Cancer PRS report from local genome-derived evidence and supplied reference resources.
...
For this package, focus on cancer polygenic-risk-score education, inherited-cancer testing limits, model-unavailable disclosure, and genetic-counseling review boundaries.
...
For Cancer PRS, the public Disease Risk Genetic Test Report sample PDF contains sibling cancer-category output-structure evidence.
