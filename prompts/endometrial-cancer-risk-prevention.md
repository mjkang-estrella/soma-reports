# Endometrial Cancer Risk & Prevention local-agent prompt

Generate a plain-English Endometrial Cancer Risk & Prevention report from local genome-derived evidence and supplied reference resources.
...
For this package, focus on endometrial cancer risk and prevention education, inherited-cancer testing limits, model-unavailable disclosure, and genetic-counseling review boundaries.
...
For Endometrial Cancer Risk & Prevention, the public Disease Risk Genetic Test Report sample PDF contains sibling cancer-category output-structure evidence.
