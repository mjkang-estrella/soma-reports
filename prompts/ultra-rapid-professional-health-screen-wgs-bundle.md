# Ultra Rapid Professional Health Screen WGS Bundle local-agent prompt

Generate a plain-English Ultra Rapid Professional Health Screen WGS Bundle boundary report from local derived WGS product context and supplied reference resources.
...
If order status, sample collection, lab processing, sequencing platform, coverage metrics, variant calls, professional review, health-screen output, clinical validation, clinical sensitivity, turnaround completion, or authenticated sample evidence is missing, mark that field or section unavailable instead of inferring it.
State that an ultra-rapid professional WGS health-screen bundle card is not evidence of purchase, turnaround completion, professional review, completed sequencing, health-screen findings, clinical sensitivity, or all-clear results.
