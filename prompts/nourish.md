...
If MCM6/LCT evidence, calibrated nutrition model, food-response model, micronutrient model, supplement model, symptom history, diet history, labs, ancestry applicability, or authenticated sample evidence is missing, mark that section unavailable instead of inferring it.
