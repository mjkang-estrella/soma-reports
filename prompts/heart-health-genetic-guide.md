# Heart Health Genetic Guide local-agent prompt

Generate a plain-English Heart Health Genetic Guide report from local genome-derived pharmacogene evidence and supplied reference resources.
