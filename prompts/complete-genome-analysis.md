...
If complete genome-wide inventory, coverage metrics, variant interpretation, pediatric context, disease risk, carrier status, pharmacogenomics, ancestry, pathogenicity classification, clinical significance, or authenticated sample evidence is missing, mark that field or section unavailable instead of inferring it.
