...
Generate a plain-English Pancreatic Cancer report from local genome-derived evidence and supplied reference resources.
...
For this package, focus on pancreatic cancer education, inherited-cancer testing limits, model-unavailable disclosure, and genetic-counseling review boundaries.
...
For Pancreatic Cancer, the public Disease Risk Genetic Test Report sample PDF contains sibling cancer-category output-structure evidence.
