...
If ACTN3, ACE, calibrated longevity model, biological-age model, frailty model, disease-risk model, supplement model, lifestyle model, lab evidence, medication context, ancestry applicability, or validated personal longevity scoring evidence is missing, mark that section unavailable instead of inferring it.
