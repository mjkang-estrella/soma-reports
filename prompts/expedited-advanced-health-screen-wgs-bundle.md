# Expedited Advanced Health Screen WGS Bundle local-agent prompt

Generate a plain-English Expedited Advanced Health Screen WGS Bundle boundary report from local derived WGS product context and supplied reference resources.
...
State that an expedited WGS health-screen bundle card is not evidence of purchase, turnaround completion, completed sequencing, health-screen findings, clinical sensitivity, or all-clear results.
